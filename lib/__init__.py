...
_os_type = "ZFStor"
UPDATE_SERVER = "http://update.zfstor.org/" + _os_type
MASTER_UPDATE_SERVER = "http://update-master.zfstor.org/" + _os_type

# For signature verification
IX_CRL = "http://update.zfstor.org/updates/zfstor_crl.pem"
DEFAULT_CA_FILE = "/usr/local/share/certs/ca-root-nss.crt"
IX_ROOT_CA_FILE = "/usr/local/share/certs/zfstor-CA.pem"
